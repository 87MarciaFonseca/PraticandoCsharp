...
//criar uma data específica usa formato: aaa,mm,dd

//DateTime dataHoje = new DateTime(2023, 10, 06);


//Console.WriteLine(dataHoje );
//definir as horas:

//DateTime dataHorarioHoje = new DateTime(2023, 10, 06,22,36,30);

//Console.WriteLine(dataHorarioHoje );
